...
textbox.addEventListener('input', function () {
    ...
    if (this.value.trim().length > 0 && Number.isNaN(Number(this.value.trim())) == false) {
...
function generateNewQuestion() {
    ...
    document.getElementById("question").innerHTML = `${firstNumber} x ${secondNumber} = ${answer}`
    return randomNum
}
